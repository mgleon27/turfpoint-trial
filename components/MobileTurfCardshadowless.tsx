...
export default function MobileTurfCardss({ turf, router }: Props) {
  ...
  return (
    <div
      ...
      className="w-full min-w-170px bg-green-50 rounded-lg p-2  cursor-pointer border-1 border-gray-100 shadow-lg/10"
    >
      {/* IMAGE */}
      <img
